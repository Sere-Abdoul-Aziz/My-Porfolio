  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { 
          name: 'description', 
          content: 'SERE Abdoul Aziz, ingénieur en génie logiciel fullstack spécialisé dans le développement web, mobile et solutions SaaS. Création d\'applications performantes et innovantes.' 
        },
        
        // ✅ Mots-clés SEO
        { 
          name: 'keywords', 
          content: 'SERE Abdoul Aziz, développeur fullstack, ingénieur logiciel, Vue.js, React, Node.js, applications web, développement mobile, portfolio développeur, freelance Mali, solutions SaaS' 
        },
        ...
        // ✅ Géolocalisation (Mali)
        { name: 'geo.region', content: 'ML' },
        { name: 'geo.country', content: 'Mali' },
        ...
        { 
          ...
          content: 'Portfolio professionnel de SERE Abdoul Aziz, expert en développement web et mobile. Découvrez mes projets et services de développement.' 
        },
        ...
        { name: 'twitter:site', content: '@votre_twitter' },
        { name: 'twitter:creator', content: '@votre_twitter' },
        { name: 'twitter:title', content: 'SERE Abdoul Aziz - Ingénieur Fullstack' },
        { 
          name: 'twitter:description', 
          content: 'Expert en développement web et mobile, créateur de solutions innovantes et performantes.' 
        },
      ...
      script: [
        {
          ...
          children: JSON.stringify({
            ...
            description: 'Expert en développement web et mobile, spécialisé dans les solutions SaaS et applications performantes',
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            url: 'https://azizsere.eveilon.com',
            description: 'Portfolio professionnel de SERE Abdoul Aziz, ingénieur fullstack expert en développement web et mobile',
            author: {
              '@type': 'Person',
              name: 'SERE Abdoul Aziz'
            },
